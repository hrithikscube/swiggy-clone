...
const InputBox = ({ errormsg, label, name, value, onChange, styles }) => {
  return (
    <div class="relative  w-full">
      ...
      <label
        for={name}
        className={`body3 peer-focus:body3 peer-placeholder-shown:body3 absolute -top-3.5 left-2 bg-white px-2 text-sm text-DimGray transition-all peer-placeholder-shown:top-4  peer-placeholder-shown:text-base ${
          errormsg
